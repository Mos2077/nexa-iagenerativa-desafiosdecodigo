...
# Criando uma lista de 'ModeloIA' com suas características pontuadas na descrição:
modelos = [
...
def recomendar_modelo(caracteristicas):
    ...
    # Convertendo as capacidades inseridas pelo usuário para minúsculas:
    capacidades_usuario = [capacidade.lower() for capacidade in caracteristicas['Capacidades']]

    for modelo in modelos:
        # Convertendo as capacidades do modelo para minúsculas:
